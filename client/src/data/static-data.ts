...
import type { Project, Skill, Experience, Education, Certification, Publication } from "@/lib/schema";
...
export const projects: Project[] = [
  ...
  },
  {
    ...
    description: "System for simulating cash transactions with optimized balance tracking and transaction history modules.",
    tech: ["Python", "Data Structures", "Transaction Processing", "System Design"],
    link: null,
    repoLink: null,
...
export const skills: Skill[] = [
  ...
  },
  {
    ...
    items: ["SQL Lite", "MySQL", "Query Optimization"]
  },
  {
    id: 6,
    category: "Concepts",
