      ...
      >
        <div className="container mx-auto px-6 flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center gap-8">
            ...
            {/* Neon Cyber Resume Button */}
            <motion.a
              href="/Rubeshkanna-Ravichandran-FlowCV-Resume-20260210.pdf"
              target="_blank"
              rel="noopener noreferrer"
              className="resume-button relative px-6 py-2.5 rounded-xl font-semibold text-sm overflow-hidden"
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
            ...
            >
              {/* Gradient background */}
              <div className="absolute inset-0 bg-gradient-to-r from-purple-600 via-pink-600 to-blue-600 rounded-xl" />
              ...
              {/* Content */}
              <div className="relative flex items-center gap-2 z-10 text-white">
            ...
            >
              <nav className="flex flex-col p-6 gap-4">
                ...
                <motion.a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="mobile-resume-button flex items-center justify-center gap-2 px-6 py-3 rounded-xl font-semibold text-white bg-gradient-to-r from-purple-600 via-pink-600 to-blue-600 relative overflow-hidden mt-4"
